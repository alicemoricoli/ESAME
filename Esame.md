...
- si "pulisono" le immagini con la funzione **mask2clouds** di mascheramento delle nubi, escludendo i pixel in cui sono presenti nuvole o cirri. La banda QA60 (Quality Assessment band a 60 metri di risoluzione) di Sentinel-2 contiene informazioni sulla qualità dei pixel;
...
library(imageRy) # 🖼️ pacchetto per la visualizzazione e manipolazione delle immagini raster
